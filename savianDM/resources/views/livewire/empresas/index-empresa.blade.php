                    ...
                    <tbody>
                        @foreach ($empresas as $item)
                            <tr class="group">
                                ...
                                <td
                                    class="sticky right-0 z-10 bg-white/90 backdrop-blur-md px-4 sm:px-6 py-4 rounded-r-2xl sm:rounded-r-3xl border-y border-r border-transparent text-right whitespace-nowrap shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.02)]">
