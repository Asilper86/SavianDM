        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4 px-2">
            <div>
                <div class="flex items-center gap-3 mb-1">
                    ...
                    <h3 class="text-2xl sm:text-4xl font-black text-slate-800 tracking-tighter">Panel de Modelos</h3>
                </div>
                ...
                <table class="w-full border-separate border-spacing-y-3">
                    <thead class="sticky top-0 bg-white/10 backdrop-blur-md z-10">
                        <tr class="text-slate-400">
                            <th class="px-6 py-3 text-[10px] font-black uppercase tracking-widest text-left w-20">ID
                            </th>
                        ...
                        @foreach ($modelos as $item)
                            <tr class="group">
                                <td
                                    ...
                                    #{{ $item->id }} </td>
                                <td
                                    class="bg-slate-50/50 px-6 py-5 border-y border-transparent font-black text-slate-700">
