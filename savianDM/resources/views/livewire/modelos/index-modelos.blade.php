<div class="w-full min-h-screen bg-[#F3F4F6] p-2 sm:p-4 md:p-8 flex flex-col font-sans">
    <div
            ...
            <div class="flex flex-row justify-between items-center w-full lg:w-auto">
                <div>
                    <div class="flex items-center gap-2 sm:gap-3 mb-1">
                        ...
                        <h3 class="text-xl sm:text-4xl font-black text-slate-800 tracking-tighter">Panel de Modelos</h3>
                    </div>
                    <p class="text-slate-400 text-xs sm:text-sm font-medium sm:ml-11">
                    </p>
                </div>
                <div class="lg:hidden shrink-0">
                    @livewire('modelos.create-modelos')
                </div>
            </div>

            <div class="w-full lg:flex-1 lg:max-w-md lg:mx-4">
                <input type="text" wire:model.live="buscar" placeholder="Buscar modelo por nombre..."
        ...
        @else 
            <x-mios.advertencia>
                No se ha encontrado ningún modelo.
            </x-mios.advertencia>
        @endif
        ...
        <x-slot name="footer">
            <div class="flex items-center justify-between w-full">
                ...
                <button wire:click="edit" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove wire:target="editar">Registrar Modelo</span>
