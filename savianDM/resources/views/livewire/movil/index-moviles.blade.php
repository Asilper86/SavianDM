                    ...
                    <tbody>
                        @foreach ($moviles as $item)
                            <tr class="group">
                                ...
                                <td
                                    class="bg-slate-50/50 group-hover:bg-white px-4 sm:px-6 py-4 sm:py-5 transition-all border-y border-transparent group-hover:border-slate-100 font-bold text-slate-600 whitespace-nowrap" x-data="{ open: false }">
                                ...
                                <td
                                    class="bg-slate-50/50 group-hover:bg-white px-4 sm:px-6 py-4 sm:py-5 transition-all border-y border-transparent group-hover:border-slate-100 text-xs font-medium text-slate-400 whitespace-nowrap" x-data="{ open: false }">
        ...
        <x-dialog-modal wire:model="openEditar" maxWidth="2xl">
            ...
            <x-slot name="content">
                <div class="px-4 pb-6 space-y-6">
                    <div class="space-y-2">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">C├│digo
                            Identificador</label>
