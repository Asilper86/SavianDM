    ...
    <div class="min-h-screen bg-green-50/50 p-4">
        ...
        <div class="bg-green-600 rounded-xl shadow-md p-4 mb-6 flex flex-wrap gap-3 items-center justify-between">
            <div class="flex flex-wrap gap-3 flex-grow">
                ...
                <select
                    class="rounded-lg border-none focus:ring-2 focus:ring-green-400 text-sm w-48"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-green-100 overflow-hidden">
            <table class="w-full table-fixed divide-y divide-gray-200">
                <thead class="bg-green-50">
                    <tr>
                        <th class="w-[10%] px-3 py-3 text-left text-xs font-semibold text-green-800 uppercase tracking-wider cursor-pointer" wire:click="ordenar('codigo')">
                            <i class="fas fa-sort mr-1"></i>SN
                        </th>
                        <th class="w-[12%] px-3 py-3 text-left text-xs font-semibold text-green-800 uppercase tracking-wider cursor-pointer" wire:click="ordenar('tipoCompra')">
                            <i class="fas fa-sort mr-1"></i>Tipo Compra
                        </th>
                        <th class="w-[16%] px-3 py-3 text-left text-xs font-semibold text-green-800 uppercase tracking-wider cursor-pointer" wire:click="ordenar('modelo')">
                            <i class="fas fa-sort mr-1"></i>Modelo
                        </th>
                        <th class="w-[18%] px-3 py-3 text-left text-xs font-semibold text-green-800 uppercase tracking-wider">
                            Empresa
                        </th>
                        <th class="w-[18%] px-3 py-3 text-left text-xs font-semibold text-green-800 uppercase tracking-wider">
                            Centro Trabajo
                        </th>
                        <th class="w-[16%] px-3 py-3 text-left text-xs font-semibold text-green-800 uppercase tracking-wider">
                            Proveedor
                        </th>
                        <th class="w-[10%] px-3 py-3 text-center text-xs font-semibold text-green-800 uppercase tracking-wider">
                            Acciones
                        </th>
                    </tr>
                </thead>
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @foreach ($moviles as $item)
                        <tr class="hover:bg-green-50/30 transition">
                            ...
                            <td class="px-3 py-3 text-sm text-gray-600 leading-5 break-words">
                                {{ $item->empresa->centroTrabajo->nombre }}
                            </td>
