<div class="space-y-10 p-3">
                ...
                <div class="space-y-4">
                    ...
                    <div class="w-full bg-slate-100 h-4 rounded-full overflow-hidden p-1">
                        <div class="bg-[#07CBBB] h-full rounded-full shadow-[0_0_15px_rgba(7,203,187,0.4)]"
                            style="width:{{ ($item->movils_count / $moviles->count() * 100) }}%"></div>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    <div class="relative group overflow-hidden bg-slate-900 rounded-[3.5rem] min-h-[450px] flex items-center justify-center border border-slate-800 shadow-2xl">
        ...
        <div class="relative z-10 text-center px-6">
            ...
            <h4 class="text-2xl font-black text-white tracking-tighter mb-3 uppercase">Geolocalización en tiempo real</h4>
            <p class="text-[10px] font-black text-[#07CBBB] uppercase tracking-[0.4em] mb-8 opacity-70">Módulo en fase de implementación</p>
