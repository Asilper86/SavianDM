<div>
    <div class="min-h-screen bg-slate-50 p-6">
        ...
        <div class="max-w-7xl mx-auto mb-10">
            <div
                class="bg-white border border-slate-200 rounded-[2.5rem] p-4 shadow-sm flex flex-col md:flex-row gap-4 items-center">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
            ...
            <div
                class="md:col-span-3 bg-white p-10 rounded-[3rem] shadow-xl border border-white text-center flex flex-col justify-center">
